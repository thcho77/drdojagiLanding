...
export const TRANSLATIONS = {
  ko: {
    ...
    menadione: {
      ...
      compHeader: { cat: "비교 항목", k1: "비타민 K1 (필로퀴논)", k2: "비타민 K2 (메나퀴논)", k3: "비타민 K3 (메나다이온) ✦" },
      compRows: [
        { label: "주요 유래",        k1: "식물성 추출물",                          k2: "발효 유제품 / 장내 세균",                      k3: "고순도 활성 전구체" },
        { label: "분자 크기 및 구조", k1: "크고 복잡함 (식물성 추출)",               k2: "크고 복잡함 (발효 유래)",                      k3: "가장 작고 단순함 (활성 전구체)" },
        { label: "피부(각질층) 투과율", k1: "낮음 ~ 보통",                           k2: "보통",                                        k3: "매우 높음 (저분자 구조로 K2 대비 2~3배)" },
        { label: "주요 활용 범위",    k1: "완만한 피부 장벽 케어",                  k2: "뼈/혈액 건강 중심 (피부 적용 한계)",           k3: "모세혈관 강화 및 정체된 어혈(멍)의 빠른 분해 — 피부 컨디셔닝 및 진정" },
        { label: "기대 효과",         k1: "데일리 홍조 및 보습 진정",               k2: "피부용 제품으로는 활용도 낮음",                 k3: "급성 붓기, 멍, 다크서클 등 효율적인 도움 기대" },
      ],
    },
    specialCare: {
      items: [
  ...
  en: {
    ...
    menadione: {
      ...
      compHeader: { cat: "Category", k1: "Vitamin K1 (Phylloquinone)", k2: "Vitamin K2 (Menaquinone)", k3: "Vitamin K3 (Menadione) ✦" },
      compRows: [
        { label: "Main Source",                   k1: "Plant Extracts",                                    k2: "Fermented Dairy / Gut Bacteria",                   k3: "High-purity Active Precursor" },
        { label: "Molecular Size & Structure",    k1: "Large & complex (plant origin)",                    k2: "Large & complex (fermentation origin)",             k3: "Smallest & simplest (active precursor)" },
        { label: "Skin Permeability",             k1: "Low to Moderate",                                   k2: "Moderate",                                         k3: "Very High (2–3× vs K2, low-MW structure)" },
        { label: "Main Application",              k1: "Mild skin barrier care",                            k2: "Bone/blood health focus (limited skin application)", k3: "Capillary strengthening & rapid breakdown of bruising — skin conditioning & soothing" },
        { label: "Expected Effect",               k1: "Daily redness & moisture soothing",                 k2: "Low utility in topical skincare",                  k3: "Efficient support for acute puffiness, bruising & dark circles" },
      ],
    },
    specialCare: {
      items: [
